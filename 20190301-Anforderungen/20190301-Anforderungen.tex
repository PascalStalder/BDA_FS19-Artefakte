...
\begin{itemize}
	...
	\item Das MVP soll in der Lage sein, dem Endbenutzer in beliebiger Form mitzuteilen (kann Akustisch, Visuell oder durch Ausschleusen gelöst werden), welcher Behälter eine Unstimmigkeit enthält.
\end{itemize}

\vfill

Mit dieser Unterschrift wird bestätigt, dass die Anorderungen gelesen, verstanden und
Akzeptiert wurden.
