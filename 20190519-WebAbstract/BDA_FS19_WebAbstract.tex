...
\pdfinfo{
	...
	/Title (Suche von mit RFID ausgeruesteten Einzelexemplaren in vollautomatischem Behaelter Hochregallager)
	/Subject (RFID)
	/Keywords (RFID, Logistik, Machbarkeitsstudie, Suchalgorithmus)
	/Copyright (2019 (C) Pascal Baumann, Dane Wicki)
	/Copyrighted (True)
