...
\begin{table}[H]
	...
	\begin{tabularx}{.7\textwidth}{Xrr}
		\hline
		\textbf{Ergebnisse der Algorithmen} & \textbf{CNN} & \textbf{Threshold}\\
		\hline 
		\textit{Gesamtanzahl Personen in Bilder} & \multicolumn{2}{c}{718}\\
		\hline
		...
		\hline
		\textit{Recall} & \textit{91.5\%} & \textit{90.5\%} \\
		\hline  
		\textit{Precision} & \textit{84.5\%} & \textit{82.1\%}\\
		\hline
		\textit{F1-Score} & \textit{87.9\%} & \textit{86.1\%}\\
		\hline
	\end{tabularx}
