...
\hypersetup{
	pdftitle={Suche von mit RFID-ausgerüsteten Einzelexemplaren in vollautomatischem Behälter-Hochregallager},
	pdfauthor={Pascal Baumann, Dane Wicki},
	pdfdate={2019-05-23},
	pdfcopyright={Copyright (C) 2019, Pascal Baumann, Dane Wicki},
	pdfsubject={RFID},
	pdfkeywords={RFID, Logistik, Machbarkeitsstudie, Suchalgorithmus},
	pdflang={de},
	pdfmetalang={de},
	pdfapart={2},
	pdfaconformance={B},
